...
void solve()
{
    ...
    for(int i=1;i+1<=n;i++)
    {
        ...
        for(int i=1;i+3<=n;i++)
        {
            if(a[i]==0 and a[i+1]!=a[i+2] and a[i+3]==0)
            {
                cout<<4<<nl;
                return;
            }
        ...
        // for(int i=1;i+4<=n;i++)
        // {
        //     if(a[i]==0 and a[i+1]!=a[i+2] and a[i+3]!=a[i+4] and a[i+5]==0)
        //     {
        //         cout<<5<<nl;
        //         return;
        //     }
        ...
        // for(int i=1;i+5<=n;++i)
        // {
        //     if(a[i]==0 and a[i+1]!=a[i+2] and a[i+3]!=a[i+4] and a[i+5]!=a[i+6] and a[i+7]==0)
        //     {
        //         cout<<6<<nl;
        //         return;
        //     }
        ...
        for(int i=1;i+6<=n;++i)
        {
            if(a[i]==0 and a[i+3]==0 and a[i+6]==0 and a[i+1]==a[i+2] and a[i+4]==a[i+5] and a[i+1]!=a[i+4])
            {
                cout<<7<<nl;
                return;
            }
