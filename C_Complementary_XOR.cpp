...
void solve()
{
    ...
    if(s==str)
    {
        ...
        f1(i,0,n-1)
        {
            if((str[i]=='0' and str[i+1]=='0'))flage1=true;
            if((str[i]=='1' and str[i+1]=='1'))aux=true;
        }
        ll c1=0;ll c2=0;
        f1(i,0,n)
        {
        ...
        if(c2%2==0){
            ...
            f1(i,0,n)
            {
                if(str[i]=='0')cout<<i+1<<" "<<i+1<<nl;
            }
            cout<<1<<" "<<n<<nl;
            return ;
        }
        if(flage1==false and aux==false){
            cout<<"NO"<<nl;
            return ;
        }
        ll count=0;
        if(flage1){
            ...
            f1(i,0,n)
            {
                if(str[i]=='0' and i!=idx1 and i!=idx2){
                    cout<<i+1<<" "<<i+1<<nl;
                }
            }
            cout<<1<<" "<<n<<nl;
        ...
        if(aux){
            ...
            f1(i,0,n)
                {
                if(str[i]=='1' and i!=idx1 and i!=idx2)
                {
                    cout<<i+1<<" "<<i+1<<nl;
                }
            }
