...
int solve()
{
   ...
   // f1(i,0,n)cin>>a[i];
   // sort(a,a+n);
   // if(n%2 or a[n/2]==a[n/2-1] and count(a,a+n,a[n/2])>=n/2){cout<<"NO"<<nl;}
   // else cout<<"YES"<<nl;
...
freopen("output.txt","w",stdout);  //file output.txt is opened in writing mode i.e "w"
    ...
    int n;cin>>n;f1(i,0,n){cin>>a[i];}
    if(n%2==1){cout<<"NO"<<nl;continue;}
    sort(a,a+n);
    f1(i,1,n/2)
    {
        if(a[i]>=a[i+n/2-1]){cout<<"NO"<<nl;goto g;}
    }
