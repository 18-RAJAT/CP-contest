...
{
    // ll n;cin>>n;
    // if(n<=4){cout<<n-2<<" "<<n-3<<" "<<n-1<<" "<<n-0<<nl;}
    // else if(n==5){cout<<n-4<<" "<<n-3<<" "<<n-2<<" "<<n-1<<nl;}
    // else if(n<=9){cout<<n-2<<" "<<n-1<<" "<<n-5<<" "n-4<<" "<<n-3<<" "<<n<<nl;}
    // int n;cin>>n;
    // int a[n];
    // f1(i,0,n)cin>>a[i];
    // if(n==4){cout<<"2 1 3 4";}
    // a[n-1]=n;a[n-2]=n-1;a[n-3]=1;a[n-4]=3;a[n-5]=2;

    // // f1(i,0,n-5)
    // rf(i,0,n-5)
    // {a[i]=i+4;}f1(i,0,n)cout<<a[i]<<" ";
    // cout<<nl;
