...
void solve()
{
    int blastCost,fillCost;
    string buildings;
    int sequences=0;
    int gap=0;
    bool sequenceOn=false;

    cin>>blastCost>>fillCost>>buildings;

    int canFill=blastCost/fillCost;
    int willFill=0;
    int lessSequences=0;
    ...
    int isCost=((sequences-lessSequences)*blastCost)+(willFill*fillCost);
    cout<<isCost<<nl;
}
