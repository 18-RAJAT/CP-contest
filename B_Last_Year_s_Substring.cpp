...
bool solve()
{
    ...
    string s;cin>>s;
    int m=s.size();
        if(s.substr(0,4)=="2020" or s.substr(m-4,4)=="2020" or s.substr(0,3)=="202" and s[m-1]=='0' or s.substr(0,2)=="20" and s[m-2]=='2' and s[m-1]=='0' or s.substr(0,1)=="2" and s[m-3]=='0' and s[m-2]=='2' and s[m-1]=='0' or s[m-4]=='2' and s[m-3]=='0' and s[m-2]=='2' and s[m-1]=='0')
        {
            cout<<"YES"<<nl;
        }
        else
