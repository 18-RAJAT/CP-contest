...
void solve()
{
    ...
    /*
        ...
        1<n move next
        8>n then 8/2=4 now 8=8 next
        25>n then 25/2=11 then check 11>n again 11/2=5 check 5>n again 5/2=2 now 2<n next
        2<n

        all are diff num then YES

    */
    // int a[101];bool flag[101];
    ll n;cin>>n;
    // VI v(n+1);
    // f1(i,0,n)
    cf(i,1,n)
    {
        ...
        // cin>>v[i];
        // sort(v.begin(),v.end());
        // ll currentVal;cin>>currentVal;
        // while(currentVal>n or v[currentVal]==1)
        // {
        //     currentVal=currentVal/2;
        //     if(currentVal==0){cout<<"NO"<<nl;return;}
        // } 
        //     v[currentVal]=1;
            // cout<<"YES"<<nl;
    // }
    ...
    {
        int temp=a[i];
        while(temp>n or flag[temp])
            temp=temp/2;
        if(temp>0)flag[temp]=true;
        else f=false;
    }
    if(f)cout<<"YES"<<nl;else cout<<"NO"<<nl;
}
