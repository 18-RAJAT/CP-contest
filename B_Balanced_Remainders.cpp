...
int code()
{
    ...
    //                 f1(k,j+1,p)
    //                 {
    //                     result+=abs(a[i][j].first-a[i][k].first)+abs(a[i][j].second-a[i][k].second);
    //                 }
    //             }
    //         }
    //     }
    ...
    // if(a+b>c){cout<<0<<nl;}
    // else cout<<1<<nl;
    // if((a+b+c)%3==0)cout<<0<<nl;else cout<<1<<nl;
...
// }
    ...
    // int n;cin>>n;
    VI v(n),ct(3);
    f1(i,0,n){cin>>v[i];ct[v[i]%3]++;}
    cout<<max(ct[0]-ct[2],max(ct[2]-ct[1],max(ct[2]-ct[1],ct[1]-ct[0])))<<nl;
