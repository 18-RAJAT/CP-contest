...
// VI b(10000001);
// VI c(10000001);
ll n,m,a[234567],x[234567],sum[234567],res[234567],flag=false;
//ll i,j;
...
void solve()
{
    ...
    //     {
    //         flag=0;
    //         for(auto it:mp[b[left-1]])
    //         {
    //             if(it<right and it>left and (it-left)%2==0)
    //             {
    //                 flag=1;
    //                 break;
    //             }
    ...
    while(m--)
    {
        ...
        if(x[right]==x[left-1])
        {
            ...
            else if((right-left+1)%2 or !a[left] or !a[right])
            {
                // cout<<left+right-1<<nl;
                flag=true;
                cout<<1<<nl;
            }
            else if(res[right]>left)
            {
                // cout<<"val("<<right<<")"<<nl;
                flag=true;
                cout<<2<<nl;
