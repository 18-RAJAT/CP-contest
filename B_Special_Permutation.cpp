...
{
         int n,a,b;cin>>n>>a>>b;
    // if(a>n/2+1 or b>n/2)cout<<-1<<nl;
    // else if((a==n/2+1 and b!=n/2) or (a!=n/2+1 and b==n/2))cout<<-1<<nl;
    // else if(a==n/2+1 and b==n/2)
    //     {f1(i,0,n)cout<<n-i<<" ";cout<<nl;}
    ...
    if(res!=a or res1!=b){cout<<"-1"<<nl;return;}
