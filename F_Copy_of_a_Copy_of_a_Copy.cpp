...
void solve()
{
    ...
    f1(i,0,k+1)
    {
        ...
        f1(j,1,n-1)
        {
            f1(k,1,m-1)
            {
                if(dp[j][k][i]==dp[j-1][k][i] and dp[j][k][i]==dp[j+1][k][i] and dp[j][k][i]==dp[j][k-1][i] and dp[j][k][i]==dp[j][k+1][i])
                {
                    ct++;
                }
            }
    ...
    // sort(all(ind));
    sort(ind,ind+k+1);
    cout<<ind[0].second+1<<nl;
    cout<<k+ind[k].first-ind[0].first<<nl;
    ...
    f1(a,1,k+1)
    {
        ...
        f1(j,1,n-1)
        {
            f1(k,1,m-1)
            {
                if(!arr[j][k]==0 and dp[j][k][i]==dp[j-1][k][i] and dp[j][k][i]==dp[j+1][k][i] and dp[j][k][i]==dp[j][k-1][i] and dp[j][k][i]==dp[j][k+1][i])
                {
                    arr[j][k]=1;
                    cout<<1<<" "<<j+1<<" "<<k+1<<nl;
                }
